...
Otra mejora técnica importante, en caso de convertir el proyecto en una aplicación real desplegada para usuarios, sería sustituir la base de datos H2 en memoria por una base de datos persistente, como PostgreSQL o MySQL. H2 resulta cómoda para el desarrollo y las pruebas, porque no requiere instalación adicional y permite empezar a trabajar rápidamente. Sin embargo, al estar configurada en memoria, los datos desaparecen cuando se detiene el backend. Una base de datos persistente permitiría conservar máquinas, configuraciones, historiales y progreso de usuarios aunque el servidor se reiniciase o sufriera una caída.
