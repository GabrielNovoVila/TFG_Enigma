...
Vamos a dividirlo en varias secciones, para que no quede un dibujo enorme ya que al final, el objetivo de este tipo de diagramas es el de la simplicidad y el de entender correctamente las posibles acciones por parte del usuario.
...
\begin{figure}[htbp]
	\centerline{\includegraphicssafe[width=14cm]{figuras/diagrama_clases_controlador.png}}
...
\begin{figure}[htbp]
	\centerline{\includegraphicssafe[width=14cm]{figuras/diagrama_clases_servicio.png}}
...
\begin{figure}[htbp]
	\centerline{\includegraphicssafe[height=14cm]{figuras/diagrama_clases_dtoRepo.png}}
...
\begin{figure}[htbp]
	\centerline{\includegraphicssafe[height=14cm]{figuras/diagrama_clases_modelo.png}}
...
\begin{figure}[htbp]
	\centerline{\includegraphicssafe[height=14cm]{figuras/diagrama_clases_v1.png}}
...
\begin{figure}[htbp]
	\centerline{\includegraphicssafe[height=14cm]
		{figuras/pagina_principal.png}}
...
\begin{figure}[htbp]
	\centerline{\includegraphicssafe[height=14cm]
		{figuras/funcionamiento.png}}
	\caption{¿Cómo funciona?}
	\label{funcionamiento}
\end{figure}

Por un lado, de forma común al resto de pestañas, tenemos el header y el footer, que almacenan la información previamente comentada.

Por otro, hablaremos de la información única que nos proporciona la pestaña. 
...
La pestaña informativa \ref{historia} creada fue la de la historia alrededor de la máquina.
\begin{figure}[htbp]
	\centerline{\includegraphicssafe[height=14cm]
		{figuras/historia.png}}
	\caption{Historia}
	\label{historia}
\end{figure}
