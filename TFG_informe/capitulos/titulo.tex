...
\begin{center}
	...
	\vspace{0.5cm}
	\includegraphicssafe[width=5cm]{figuras/logo_usc.eps}
	
	\vspace{0.5cm}
	{\bf\large ESCOLA TÉCNICA SUPERIOR DE ENXEÑARÍA}
	
	\vspace{3cm}
	{\bf\LARGE Simulador máquina Enigma M3}
	
	\vspace{0.5cm}
	{\bf\ Hecho con Spring Boot y React}
\end{center}

\vspace{2cm}
\hspace{4cm}\begin{tabular}{l}
	{\it\Large Autor/a:} \\
	{\bf\Large Gabriel Novo Vila} \\
	~ \\
	{\it\Large Titor:} \\
	{\bf\Large Pablo García Tahoces} \\
\end{tabular}
